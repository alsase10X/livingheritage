    ...
    <header className="sticky top-0 z-10 flex flex-col bg-background">
      ...
      <div className="flex flex-col px-4 py-3 md:hidden">
        <div className="flex items-center gap-3">
          {showSidebarToggle && hasSidebarProvider && <SidebarToggle />}

          <div className="flex-1" />

          {(!hasSidebarProvider || windowWidth < 768) && (
            <Button className="h-8 shrink-0 px-2" size="sm" variant="outline">
              <PlusIcon />
        ...
        {/* Imagen circular del bien - Encima del título */}
...
export const BienChatHeader = memo(
  PureBienChatHeader,
  (prevProps, nextProps) => {
    return (
